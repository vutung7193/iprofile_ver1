...
<body>
  ...
  <header class="navbar navbar-static-top bs-docs-nav" id="top" role="banner"  itemscope="itemscope" itemtype="http://schema.org/WPHeader">
    ...
    <div id="iprofile_home" style="width: 1000px">
    ...
    <ul>
      <li>
        ...
        <ul>
            ...
            {
                 ?>   <li>
            <a href="<?php echo $this->createUrl('/site/project', array('id' =>$model->id)) ?>"><?php echo $model->name?></a>
